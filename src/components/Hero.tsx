    ...
    >
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <a
            href="#portfolio"
            className="px-8 py-3 bg-black text-white font-semibold rounded-full border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)] hover:scale-105 transition-all duration-300"
          >
            Projects
          </a>
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=dikachinwankwo575@gmail.com"
            className="px-8 py-3 bg-black text-white font-semibold rounded-full border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)] hover:scale-105 transition-all duration-300"
          >
            Hire Me
          </a>
